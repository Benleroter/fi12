"""
Django settings for fungiidentifier11 project.
...
ALLOWED_HOSTS = ['0.0.0.0', '127.0.0.1', 'localhost','fungi-id.co.uk','www.fungi-id.co.uk','fungiidentifier11.eba-yupcnhd5.eu-west-2.elasticbeanstalk.com','172.31.12.60','18.169.127.90']
...
ROOT_URLCONF = 'fungiidentifier11.urls'
...
WSGI_APPLICATION = 'fungiidentifier11.wsgi.application'
